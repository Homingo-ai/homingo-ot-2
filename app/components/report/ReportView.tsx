...
const ReportView: React.FC<ReportViewProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="report-toolbar-actions"
                  ...
                  >
                    {["House", "Flat", "Maisonette", "Bungalow"].map((type) => (
                      <SmallCheckbox
                        ...
                        label={type}
                        checked={
                          getVal("propertyType", wizardData.propertyType) ===
                          type
                        }
                ...
                <div style={{ display: "flex", gap: "20px" }}>
                  ...
                  >
                    <ChoiceBox
                      ...
                      isLocked={isLocked}
                      onClick={() =>
                        handleOverride("communalDoorPresent", true)
                      }
                    />
                    <ChoiceBox
                      label="NO (Go to 4)"
                      ...
                      isLocked={isLocked}
                      onClick={() =>
                        handleOverride("communalDoorPresent", false)
                      }
                    />
                  </div>
                  {
                              ...
                              checked={
                                getVal(
                                  ...
                                  (rawAhr.external_access?.communal_front_door
                                    ...
                                    ? "above10"
                                    : (rawAhr.external_access
                                          ?.communal_front_door
                                          ?.threshold_height_cm?.value || 0) >
                                        1.5
                                      ? "between"
                                      : "below1.5",
                                ) === t.val
                ...
                <div style={{ display: "flex", gap: "20px" }}>
                  ...
                  >
                    <ChoiceBox
                      ...
                      isLocked={isLocked}
                      onClick={() =>
                        handleOverride("communalLiftPresent", true)
                      }
                    />
                    <ChoiceBox
                      label="NO (Go to 6)"
                      ...
                      isLocked={isLocked}
                      onClick={() =>
                        handleOverride("communalLiftPresent", false)
                      }
                    />
                  </div>
                  {
                ...
                <div style={{ display: "flex", gap: "20px" }}>
                  ...
                  >
                    <ChoiceBox
                      ...
                      isLocked={isLocked}
                      onClick={() =>
                        handleOverride("propertyDoorPresent", true)
                      }
                    />
                    <ChoiceBox
                      label="NO (Go to 7)"
                      ...
                      isLocked={isLocked}
                      onClick={() =>
                        handleOverride("propertyDoorPresent", false)
                      }
                    />
                  </div>
                  {
                    ...
                    >
                      ...
                      >
                        ...
                        <AHR_MeasurementBox
                          ...
                          isLocked={isLocked}
                          onChange={(v) =>
                            handleOverride("propertyDoorWidth", v)
                          }
                        />
                      </div>
                    </div>
            ...
            <SectionBlock title="SECTION D (Continued)" number="">
              ...
              >
                ...
                >
                  ...
                  >
                    STOP NOW if there are more than 4 steps at both communal
                    front door or property front door
                  </span>
                  <div
                    style={{
                      display: "flex",
            ...
            <SectionBlock title="SECTION E (Continued)" number="">
                ...
                >
                  ...
                  >
                      ...
                      >
                        ...
                        <div style={{ display: "flex", gap: "8px" }}>
                          <SmallCheckbox
                            ...
                            isLocked={isLocked}
                            onClick={() =>
                              handleOverride("stairsPresent", true)
                            }
                          />
                          <SmallCheckbox
                            label="N"
                            ...
                            isLocked={isLocked}
                            onClick={() =>
                              handleOverride("stairsPresent", false)
                            }
                          />
                        </div>
                      </div>
                    ...
                    >
                      ...
                      >
                        Is there at least 70cm between bottom of stair and
                        leading edge of front door?
                      </span>
                      <div style={{ display: "flex", gap: "10px" }}>
                        <SmallCheckbox
                          label="Y"
              ...
              >
                ...
                >
                  <div style={{ flex: 1 }}>
                    <span style={{ fontSize: "12px", fontWeight: "900" }}>
                      STOP NOW If there is less than 70cm between bottom stair
                      and leading edge of door
                      <br />
                          ...
                          <AHR_MeasurementBox
                            ...
                            onChange={() =>
                              openModal(
                                ...
                                getVal(
                                  "wheelchairStorageLength",
                                  rawAhr.internal_circulation
                                    ?.wheelchair_storage?.dimensions_cm
                                    ?.length ??
                                    wizardData.wheelchairStorageLengthCm,
                                ),
                              )
                      ...
                      <SmallCheckbox
                        ...
                        checked={
                          getVal(
                            ...
                            rawAhr.room_analysis?.kitchen
                              ?.separate_from_living ??
                      ...
                      >
                        ...
                        <div style={{ display: "flex", gap: "6px" }}>
                          ...
                          <SmallCheckbox
                            label="N"
                            checked={
                              getVal("bathroomLAShower", false) === false
                            }
                            isModified={isMod("bathroomLAShower")}
                            isLocked={isLocked}
                            onClick={() =>
                      ...
                      >
                        ...
                        <div style={{ display: "flex", gap: "6px" }}>
                          ...
                          <SmallCheckbox
                            label="N"
                            checked={
                              getVal("bathroomBathOnly", false) === false
                            }
                            isModified={isMod("bathroomBathOnly")}
                            isLocked={isLocked}
                            onClick={() =>
                  ...
                  >
                    ...
                    <div style={{ display: "flex", gap: "6px" }}>
                      ...
                      <SmallCheckbox
                        ...
                        isLocked={isLocked}
                        onClick={() =>
                          handleOverride("parkingType", "ON_STREET")
                        }
                      />
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div style={{ display: "flex", gap: "6px" }}>
                      <SmallCheckbox
                        ...
                        isLocked={isLocked}
                        onClick={() =>
                          handleOverride("parkingDesignated", true)
                        }
                      />
                      <SmallCheckbox
                        label="N"
                        ...
                        isLocked={isLocked}
                        onClick={() =>
                          handleOverride("parkingDesignated", false)
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div style={{ display: "flex", alignItems: "center" }}>
                    ...
                    >
                      <SmallCheckbox
                        ...
                        isLocked={isLocked}
                        onClick={() =>
                          handleOverride("proximityTransport", true)
                        }
                      />
                      <SmallCheckbox
                        label="N"
