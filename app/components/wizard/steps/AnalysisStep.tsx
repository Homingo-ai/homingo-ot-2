            ...
            <div className="max-w-[500px] mx-auto">
                {isAnalyzing ? (
                    <div className="flex flex-col items-center gap-5">
                        ...
                        <div>
                            <h3 className="text-xl font-extrabold text-primary mb-2">Analyzing Compliance</h3>
                    ...
                    <div className="flex flex-col items-center gap-6">
                        ...
                        <div>
                            <h3 className="text-2xl font-extrabold text-slate-800 mb-2">Assessment Ready</h3>
                        ...
                        <div className="grid grid-cols-2 gap-3 w-full">
                            <div className="p-5 bg-white rounded-[20px] border border-border flex items-center gap-4 text-left">
                                ...
                                <div>
                                    <span className="block text-xs font-bold text-slate-500 mb-0.5">Compliance</span>
                                    <span className="text-xl font-extrabold text-slate-800">{formData.aiReport?.AccessibilityScore || 'Pending…'}</span>
                                </div>
                            </div>
                            <div className="p-5 bg-white rounded-[20px] border border-border flex items-center gap-4 text-left">
                                <FileText size={18} className="text-green-600" />
                                <div>
                                    <span className="block text-xs font-bold text-slate-500 mb-0.5">Grade</span>
                                    <span className="text-xl font-extrabold text-slate-800">{formData.aiReport?.Grade || '—'}</span>
                                </div>
                            </div>
                        </div>

                        <div className="p-5 bg-slate-50 rounded-[20px] border border-slate-200 w-full text-left">
                            <h4 className="text-[13px] font-extrabold text-slate-800 mb-3 uppercase">Next Steps</h4>
